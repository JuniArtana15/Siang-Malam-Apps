...
public class DashboardFragment extends Fragment  {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == PICK_IMAGE) {
            ...
            try {
                ...
                System.out.println("Masukkan imageByte :"+imageByte);
    ...
    private void saveFood(){
        ...
        if(name.isEmpty()){
            ...
            //error name is empty
            Toast.makeText(getActivity(), "Tambahkan Harga Makanan atau Minuman", Toast.LENGTH_SHORT).show();
        } else if(stamp.isEmpty()){
            //error name is empty
            Toast.makeText(getActivity(), "Jumah Makanan atau Minuman Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
